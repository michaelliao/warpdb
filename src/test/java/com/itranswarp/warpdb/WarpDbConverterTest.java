...
public class WarpDbConverterTest extends WarpDbTestBase {
    ...
    public void testInsertableFieldsAndValues() throws Exception {
        ...
        assertArrayEquals(new String[] { "f_name", "f_Target_date", "targetDateTime", "address", "id", "createdAt", "updatedAt", "version" }, fields);
        assertArrayEquals(new Object[] { "ATest", new java.util.Date(LocalDate.of(2016, 10, 20).atStartOfDay(ZoneId.systemDefault()).toEpochSecond() * 1000),
                new java.util.Date(LocalDateTime.of(2016, 10, 20, 11, 12, 13, 0).atZone(ZoneId.systemDefault()).toEpochSecond() * 1000),
                "Beijing:No.1 Road:100101", "sid-123", 0L, 0L, 0L }, warpdb.getInsertableValues(todo));
    }
}
